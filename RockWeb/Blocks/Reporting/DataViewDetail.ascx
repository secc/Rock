    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlDetails" runat="server" Visible="false">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-labels">
                        ...
                        <div class="label label-primary">
                            <asp:LinkButton ID="lbCreateReport" runat="server" OnClick="lbCreateReport_Click"><i class="fa fa-plus"></i> Create Report</asp:LinkButton>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-block" runat="server">
                    <div class="panel-heading">
                        ...
                        <div class="panel-labels">
                            ...
                            <div class="label label-primary">
                                <asp:LinkButton ID="lbViewCreateReport" runat="server" OnClick="lbCreateReport_Click"><i class="fa fa-plus"></i> Create Report</asp:LinkButton>
                            </div>
                        </div>
                    </div>
            ...
            <Rock:ModalDialog runat="server" ID="mdSql" Title="Debug SQL">
                <Content>
                    <p>
                        The following code is generated by the current dataview settings.
                    It has been truncated to the first item only to remove the chance of crashing Rock by loading too many entities.
                    </p>
                    <p>
