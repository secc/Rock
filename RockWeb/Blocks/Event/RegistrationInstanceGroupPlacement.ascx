                    ...
                    <asp:Panel runat="server" ID="pnlAddExistingPlacementGroup">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <Rock:GroupPicker ID="gpAddExistingPlacementGroup" runat="server" Label="Group" ValidationGroup="vgAddPlacementGroup"
                                    AllowMultiSelect="true" OnSelectItem="gpAddExistingPlacementGroup_SelectItem" />
                            </div>
                        </div>
                    </asp:Panel>
