            ...
            setButtonLinkType: function () {
                ...
                switch (linkType) {
                    ...
                    case "File":
                        ...
                        $('#componentButtonFileWrapper').find('.file-link').prop('href', buttonComponent.find('.button-link').prop('href'))
                        $('#componentButtonFileWrapper').find('.file-link').text(buttonComponent.attr('data-button-filename'))
                        break;
                    default:
                        //Url is default
                        //Save which type we are using on the component
                        ...
                        $('#component-button-buttonurl').val(buttonComponent.attr('data-button-url'));
